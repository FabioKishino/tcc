...
var PortalPlacementContext = (0, import_react4.createContext)({
...
var Select = function(_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function renderInput() {
      ...
      if (!isSearchable) {
        return React3.createElement(DummyInput, _extends({
          id,
      ...
      return React3.createElement(Input3, _extends({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : React3.createElement(Placeholder3, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled,
          isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function(opt, index) {
          ...
          return React3.createElement(MultiValue3, _extends({}, commonProps, {
            components: {
      ...
      return React3.createElement(SingleValue3, _extends({}, commonProps, {
        data: singleValue,
        isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return React3.createElement(ClearIndicator3, _extends({}, commonProps, {
        innerProps,
        isFocused
      }));
    }
    ...
    value: function renderLoadingIndicator() {
      ...
      return React3.createElement(LoadingIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return React3.createElement(IndicatorSeparator3, _extends({}, commonProps, {
        isDisabled,
        isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return React3.createElement(DropdownIndicator3, _extends({}, commonProps, {
        innerProps,
        isDisabled,
        isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render2(props, id) {
        ...
        return React3.createElement(Option3, _extends({}, commonProps, {
          innerProps,
          data,
          isDisabled,
          isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            ...
            return React3.createElement(Group3, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options: options2,
        ...
        if (message === null)
          return null;
        menuUI = React3.createElement(LoadingMessage3, commonProps, message);
      } else {
        ...
        if (_message === null)
          return null;
        menuUI = React3.createElement(NoOptionsMessage3, commonProps, _message);
      }
      ...
      var menuElement = React3.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        var ref = _ref4.ref, _ref4$placerProps = _ref4.placerProps, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight;
        return React3.createElement(Menu3, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          isLoading,
          placement
        }), React3.createElement(ScrollManager, {
          captureEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom,
          lockEnabled: menuShouldBlockScroll
        }, function(scrollTargetRef) {
          return React3.createElement(MenuList3, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === "fixed" ? React3.createElement(MenuPortal2, _extends({}, commonProps, {
    ...
    value: function renderFormField() {
      ...
      if (isMulti) {
        if (delimiter2) {
          ...
          return React3.createElement("input", {
            name,
            type: "hidden",
            value
          });
          ...
          return React3.createElement("div", null, input);
        }
      } else {
    ...
    value: function renderLiveRegion() {
      ...
      return React3.createElement(LiveRegion, _extends({}, commonProps, {
    ...
    value: function render() {
      ...
      return React3.createElement(SelectContainer3, _extends({}, commonProps, {
        className,
        innerProps: {
          id,
        ...
        isDisabled,
        isFocused
      }), this.renderLiveRegion(), React3.createElement(Control3, _extends({}, commonProps, {
        ...
        isFocused,
        menuIsOpen
      }), React3.createElement(ValueContainer3, _extends({}, commonProps, {
        isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), React3.createElement(IndicatorsContainer3, _extends({}, commonProps, {
        isDisabled
...
var StateManagedSelect = (0, import_react8.forwardRef)(function(props, ref) {
  ...
  return React4.createElement(Select, _extends({
    ref
  }, baseSelectProps));
});
var NonceProvider = function(_Component) {
  ...
  _createClass(NonceProvider2, [{
    ...
    value: function render() {
      ...
      return React4.createElement(CacheProvider, {
        value: emotionCache
      }, this.props.children);
    }
  }]);
...
// dep:react-select
var react_select_default = react_select_esm_default;
export {
  NonceProvider,
  components,
  createFilter,
  react_select_default as default,
  defaultTheme,
  mergeStyles,
  useStateManager
};
